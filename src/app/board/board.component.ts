...
export class BoardComponent implements OnInit {
  ...
  // this.tilesService.getSelectedTile() to aktualna płytka (tile) którą próbujemy położyć na planszy
      ...
      this.board = this.boardService.putTileOnBoard(clickedBoardField, rowIndex, colIndex, this.tilesService.getSelectedTile(), this.tilesService.getSelectedTileRotation() );
